...
with_node \
  ...
  --target "/Users/retrosoft.co/Desktop/Projects/prayer-app--/ios/Pods/Target Support Files/Pods-prayerapp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-sensors" "expo-system-ui" "expo-web-browser"
